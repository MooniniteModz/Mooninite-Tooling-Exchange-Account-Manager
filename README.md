...
Version History
VersionDateChanges5.02025-05-24Updated to Purview Compliance Center syntax (FolderID= instead of FolderID:"")4.02025-04-14Simplified menu, added Search-RecoverableItems, refactored to function-driven architecture3.02025-03-17Added menu system with Show-Logo / Show-MainMenu, credential collection at startup2.02024-11-10Refactored PS7 version checking, fixed folder size checking hangs, updated parameters1.02024-03-10Initial release
Known Behavior
